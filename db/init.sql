...
CREATE TABLE strategie (
    id_strategie BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE tournoi (
    id_tournoi BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE partie (
    id_partie BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE iteration (
    id_iteration BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
